...
public class RSyntaxTextArea extends RTextArea implements SyntaxConstants {
    ...
    protected final void doBracketMatching() {
        ...
        // exists.
        if (match != null) {
            repaint(match);        // If a matching bracket is found, get its bounds and paint it!
        }
    ...
    public static int getCodeTemplateCount() {
        return getTemplatesEnabled() ? codeTemplateManager.getTemplateCount() : -1;
    }
    ...
    public String getToolTipText(MouseEvent e) {
        String toolTip = parserManager == null ? null : parserManager.getToolTipText(e);
     ...
     */
    public void setSyntaxHighlightingColorScheme(final SyntaxHighlightingColorScheme colorScheme) {
    ...
    public synchronized static boolean setTemplateDirectory(String dir) {
        if (getTemplatesEnabled() && dir != null) {
            ...
            if (directory.isDirectory()) {
                return codeTemplateManager.setTemplateDirectory(directory) > -1;
            } else {
