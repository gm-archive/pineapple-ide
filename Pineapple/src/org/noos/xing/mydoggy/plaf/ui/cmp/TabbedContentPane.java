...
import java.util.*;
import org.gcreator.pineapple.gui.DocumentPaneContent;
...
public class TabbedContentPane extends JTabbedPane implements PropertyChangeListener,
    ...
    protected void fireCloseTabEvent(Content content) {
        if (content instanceof DocumentPaneContent) {
            DocumentPaneContent c = (DocumentPaneContent) content;
            if (!c.getPane().userRequestDispose()) {
                return;
            }
        }
