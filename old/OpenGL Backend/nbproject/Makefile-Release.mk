...
${OBJECTDIR}/dummy-interop.o: dummy-interop.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -s -D_RELEASE_ -I/usr/include/SDL -o ${OBJECTDIR}/dummy-interop.o dummy-interop.cpp
...
${OBJECTDIR}/unix-interop.o: unix-interop.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -s -D_RELEASE_ -I/usr/include/SDL -o ${OBJECTDIR}/unix-interop.o unix-interop.cpp
...
${OBJECTDIR}/functionpointer.o: functionpointer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -Wall -s -D_RELEASE_ -I/usr/include/SDL -o ${OBJECTDIR}/functionpointer.o functionpointer.cpp
